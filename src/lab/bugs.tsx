...
const defects = [
  ...
  {
    id: 'grace', title: 'Le verre disparaît après « Agrandir »', code: 'UI-018', scope: 'Web + Windows',
    image: 'grace-reported.png',
    observed: 'Cliquer « Agrandir » ferme le menu ; le verre agrandi n’est plus sous la souris et se replie en onglet une demi-seconde plus tard, sans que la lecture ait commencé.',
    steps: ['Ouvrir le menu ⋯ d’une traduction longue et cliquer « Agrandir » sans bouger la souris.', 'Attendre une seconde : le verre doit rester ouvert au moins deux secondes après le clic.', 'Éloigner la souris de plus de 32 px : le repli suit 500 ms plus tard, en fondu, l’onglet ne bouge pas.'],
    cause: 'Le repli ne regardait que le survol des surfaces serrées : dès que le menu se fermait sous le pointeur, le verre était « quitté ». Correctif : deux secondes de grâce après toute action, sortie jugée sur la silhouette (32 px autour des surfaces, mesurée nativement par le sondeur du curseur) et repli en fondu sans changement de fenêtre.',
    boundary: 'La grâce et la silhouette sont observables ici avec la souris. La mesure native du curseur (événement glass-near) et la fenêtre réservée ne sont vérifiées que par le pont IPC et le probe natif.',
    scenario: 'long',
  },
  {
