...
3. Matière : la phase A du lot 12 (verre peint, opacité relevée) est livrée par défaut. La phase B (vrai Acrylic Windows) est un essai derrière un réglage caché, désactivé par défaut, accompagné de captures et d’un constat écrit pour la décision de Lucas.
