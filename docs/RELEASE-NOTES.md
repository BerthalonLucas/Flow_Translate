...
raccourci déjà pris. À revoir avant la sortie : la mise en valeur du texte (surlignage gardé
jusqu’à la prochaine action). La ligne « Validation » reste à écrire avec les vérifications
réellement faites. -->
...
- **Le travail se voit sur le texte.** Le menu se change en une petite pilule avec un orbe (Perle, Nébuleuse ou Ruban) ; là où l’application expose sa sélection, une lumière parcourt les lignes sélectionnées, sans jamais intercepter un clic. Le résultat remplace la sélection ; la pilule se pose sous le nouveau texte sans jamais le couvrir, trace une coche et offre Annuler (8 s par défaut, en pause sous la souris), qui rend l’original. Les mots changés sont surlignés tant qu’Annuler est offert.
