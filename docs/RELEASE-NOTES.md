...
(reporté, décision 5). À revoir avant la sortie avec les retours de Lucas du 24/09 (surlignage
gardé jusqu’à la prochaine action, survol, sens d’ouverture de la grille, mise à jour propre,
raccourci déjà pris). La ligne « Validation » reste à écrire avec les vérifications réellement
faites. -->
