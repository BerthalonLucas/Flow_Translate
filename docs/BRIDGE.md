...
type Capture = { id: string; text: string; source: 'selection'|'clipboard'; origin?: 'uia'|'copy'|'fresh'|'replay'|'demo'; canReplace: boolean; anchor: Rect|null; replay?: Replay; screen?: Screen };
